...
values
  ...
  ('edredom-queen-plush-cinza', 'Edredom Queen Plush Cinza', '', 24990, 'EQ', false, true, 21),
  ('escada-de-aluminio-5-degraus-residencial', 'Escada de Alumínio 5 degraus Residencial', '', 16490, 'ED', false, true, 22),
  ('escorredor-de-louca-rack-preto-2-andares-aco', 'Escorredor de Louça Rack Preto 2 Andares Aço', '', 10115, 'ED', false, true, 23),
  ('lua-de-mel', 'Espirro em Capitólio', 'Contribua para nossa viagem de Lua de Mel', 20000, 'LM', false, true, 24),
