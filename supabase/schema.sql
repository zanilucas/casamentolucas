...
values
  ...
  ('batedeira-duo-mixer-turbo-4-litros', 'Batedeira Duo Mixer Turbo 4 Litros', '', 22990, 'BD', false, true, 5),
  ('batedeira-planetaria-preta', 'Batedeira Planetária Preta', '', 49990, 'BP', false, true, 6),
  ('blender-2-jarras-700w', 'Blender 2 Jarras 700w', '', 24990, 'B2', false, true, 7),
  ('boleira-com-tampa-28cm-bambu', 'Boleira com Tampa 28Cm - Bambu', '', 9999, 'BC', false, true, 8),
  ('bomboniere-com-pe-cristal-25cm', 'Bomboniere com Pé Cristal 25Cm', '', 11999, 'BC', false, true, 9),
  ('bomboniere-com-pe-renaissance-lyor', 'Bomboniere com Pé Renaissance Lyor', '', 9999, 'BC', false, true, 10),
  ('buffet-aparador-4-portas-mdp-mdf', 'Buffet Aparador 4 Portas MDP/MDF', '', 38998, 'BA', false, true, 11),
  ('cabeceira-casal-com-led-e-2-mesas-de-cabeceira', 'Cabeceira Casal com Led e 2 Mesas de Cabeceira', '', 67998, 'CC', false, true, 12),
  ('carrinho-organizador-multiuso-3-andares', 'Carrinho Organizador Multiuso 3 Andares', '', 12065, 'CO', false, true, 13),
  ('casinha-pra-mel', 'Casinha pra Mel', 'Um cantinho especial e confortável para a Mel.', 30000, 'CM', false, true, 14),
  ('cervejeira-92-litros-painel-touch', 'Cervejeira 92 Litros Painel Touch', '', 199990, 'C9', false, true, 15),
  ('chaleira-eletrica-com-desligamento-automatico', 'Chaleira Elétrica com Desligamento Automático', '', 13940, 'CE', false, true, 16),
  ('churrasqueira-eletrica-antiaderente', 'Churrasqueira Elétrica Antiaderente', '', 24990, 'CE', false, true, 17),
  ('conjunto-de-facas-com-suporte-7-pecas', 'Conjunto de Facas com Suporte - 7 Peças', '', 14999, 'CD', false, true, 18),
  ('contribuicao-livre', 'Contribuição Livre', 'Escolha o valor que desejar para nos ajudar nesse novo começo.', null, '+', true, true, 19),
